...
def add_container_to_index(index, container, tag, insecure, additional_tag):
    """
...
def new_index(index, insecure, additional_tag):
    """
...
def pull_container(container, tag, platform, insecure):
    """
    Push to an OCI registry.
...
def push_container(container, tag, destination, insecure):
    """
    Push to an OCI registry.
