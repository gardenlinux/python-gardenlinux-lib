...
|----------------|---------|------------------------------|
|`/etc/hostname`|**4.9%** affected<br>`container-amd64`<br>`container-arm64`<br>`container-pythonDev-amd64`<br>`container-pythonDev-arm64`|<pre>container:<br>  _archgrouped</pre>|
